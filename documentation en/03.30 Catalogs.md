...
A catalog is a collection of documents. There are two types of catalogs: GitHub catalogs and database catalogs.
...
Catalog metadata is defined in the "info" field, like this:
